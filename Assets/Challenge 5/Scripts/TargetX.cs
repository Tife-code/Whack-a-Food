...
public class TargetX : MonoBehaviour
{
    ...
    //onMouseDown confirms the mouse was clicked while onMouseEnter activates when the mouse hovers over the gameobject
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Sensor") && !gameObject.CompareTag("Bad") || gameManagerX.TimerOn == false)
        {//this will call the gameover method if the tags are confirmed OR the timer runs out
